...
public class DLevel2 extends AppCompatActivity {

    private ImageView chordDisplay, g_press, em_press, d_press, c_press,rightchoice,wrongchoice;
    private MediaPlayer missnote,rightnote,allright;
    private String[] chords = {"gdiagram", "emdiagram","ddiagram", "cdiagram"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dlevel2);
                    ...
                    if (currentUser != null) {
                        ...
                        userRef2.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(DLevel2.this, "Score uploaded successfully", Toast.LENGTH_SHORT).show();
                                                    } else {
                                                        Toast.makeText(DLevel2.this, "Failed to upload score", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                            ...
                            public void onCancelled(@NonNull DatabaseError databaseError) {
                                // Handle errors
                                progressDialog.dismiss();
                                Toast.makeText(DLevel2.this, "Failed to retrieve score: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
                    } else {
                        // User is not signed in
                        progressDialog.dismiss();
                        Toast.makeText(DLevel2.this, "User is not signed in", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
            // If there's no network connectivity, display a toast
            Toast.makeText(DLevel2.this, "No network connection", Toast.LENGTH_SHORT).show();
        }
    ...
    private void playIncorrectGuessSound() {
        ...
        if (missnote == null) {
            missnote = MediaPlayer.create(DLevel2.this, R.raw.wrong); // Replace R.raw.incorrect_guess_sound with the actual sound resource
        }
    ...
    private void playCorrectGuessSound() {
        // Initialize MediaPlayer if not already initialized
        if (rightnote == null) {
            rightnote = MediaPlayer.create(DLevel2.this, R.raw.right); // Replace R.raw.right with the actual sound resource
        }
    ...
    private void playAllGuess() {
        // Initialize MediaPlayer if not already initialized
        if (allright == null) {
            allright = MediaPlayer.create(DLevel2.this, R.raw.allguess); // Replace R.raw.incorrect_guess_sound with the actual sound resource
        }
        // Start playing the sound
        allright.start();
    }
