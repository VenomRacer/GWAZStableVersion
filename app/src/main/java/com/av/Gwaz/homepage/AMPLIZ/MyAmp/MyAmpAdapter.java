...
public class MyAmpAdapter extends RecyclerView.Adapter<MyAmpAdapter.AllViewHolder> {
    ...
    public MyAmpAdapter(List<MyGet> myList, DatabaseReference databaseReference, StorageReference storageReference, MyAmpAdapter.OnItemClickListener listener) {
        this.myList = myList;
    ...
    @NonNull
    @Override
    public MyAmpAdapter.AllViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my, parent, false);
        return new AllViewHolder(view);
    }

    public interface OnItemClickListener {
        void onItemClick(MyGet item);
    }

    @Override
    public void onBindViewHolder(@NonNull MyAmpAdapter.AllViewHolder holder, int position) {
        MyGet myGet = myList.get(position);
            ...
            deleteIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        MyGet clickedItem = myList.get(position);
